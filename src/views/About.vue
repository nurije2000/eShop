  ...
  <div class="about">
    ...
    <NavBar></NavBar>
        ...
        <div class="card">
            <div class="content">
                <div class="imgBx">
                    <img src="../assets/team/fjola.jpg" alt="">
                </div>
                <div class="contentBx">
                    <h4>Fjola Ismaili</h4>
                ...
                <div class="sci">
                     <a href="https://www.facebook.com/fjolla.ismaili.587" class="fab fa-facebook-f"></a>
        ...
        <div class="card">
            <div class="content">
                <div class="imgBx">
                    <img src="../assets/team/nurije.jpg" alt="">
                </div>
                <div class="contentBx">
                    <h4>Nurije Osmani</h4>
        ...
        <div class="card">
            <div class="content">
                <div class="imgBx">
                    <img src="../assets/team/gresa.jpg" alt="">
                </div>
                <div class="contentBx">
                    <h4>Gresa Ahmeti</h4>
                    <h5> Web Designer</h5>
